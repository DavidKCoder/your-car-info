...
function App() {
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50">
            <div className="min-h-screen w-full max-w-lg p-4 bg-white shadow-md rounded-lg">
                ...
                <div className="flex justify-center items-center mb-8">
                    <img src={"https://kimuracars.com/img/autocatalog/cars2/411/nissan-x-trail-117009.jpg"} alt="car" />
                </div>
                ...
                <div
                    ...
                    <a
                        ...
                        className="text-lg font-bold text-blue-600 group-hover:text-white hover:underline"
                    >
                        @David_Coder
                    </a>
                </div>
            ...
            <div
                className="fixed bottom-0 left-0 w-full bg-gray-100 border-t border-gray-300 py-3 text-center text-gray-500 text-sm">
